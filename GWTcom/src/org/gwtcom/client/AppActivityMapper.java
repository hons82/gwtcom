...
public class AppActivityMapper implements ActivityMapper {
	...
	@Inject
	public AppActivityMapper(EventBus eventbus, PlaceController placeController, GWTcomGinjector injector,
	...
	public Activity getActivity(Place place) {
		...
		else if (place instanceof PeopleViewPlace)
			return _injector.getPeopleViewActivity();
